...
```{r foto, echo = FALSE, out.width=300, fig.align='center'}
...
::: {.fragment fragment-index=1}  
**4.** We don't have training in software development!  
...
![](img/computer.png){.style #vcenter}
...
# Capturing the computational environment is needed to ensure code reproducibility {background-color="#CDD7D6"}
...
Julia developed software and wants to share it with other researchers in the lab. **What is the best way to share the code with them?**
...
- We can assign names to each **code version** and go back to particular moment of the code

- You have a **backup** online in GitHub
...
:::footer
https://github.com/flor14/wsu-dandrea/issues/1
:::
...
![](img/openresearch.png)



::: footer
[How to Run Your Open Source Software Project - The Turing Way Handbook](https://the-turing-way.netlify.app/reproducible-research/open/open-source.html#how-to-run-your-open-source-software-project)
:::
---
...
# Git + GitHub are useful tools not only to version control files, if not also to foster collaboration and publish our code {background-color="#CDD7D6"}
...
:::: {.columns}
::: {.column width="60%" #vcenter}
A Ph.D. wants to publish the first article. **How can she do it in a reproducible way?**
...
# Computational reproducibility is also related to the project organization and documentation {background-color="#CDD7D6"}
...
- Version controlling and publishing our promotes open source collaboration 
...
- Software could need maintenance. Packages are a good example.
...
The Turing Way project involve and support a diverse community of contributors to make data science accessible, comprehensible and effective for everyone.
...
- The role of RSE has been created to recognize the effort of software developers in academia 
...
The Research Software Engineering (RSE) International Survey is a survey conducted by the UK Software Sustainability Institute since 2016 and now comprises 8 countries and covers all aspects of the practice of research software engineering.
