...
institute: "Master of Data Science program, University of British Columbia"
...
**Spoiler alert**: This talk is about my own career path
...
**1.** Researchers = Software Developers?  
**2.** Why is important to write "good software" (for research)?  
**3.** What kind of practices and/or tools we need to apply for creating better research software?
**4.** We have not training in software development! Where to find resources to learn?  

---

### Talk roadmap 🗺️

**5.** Where can I find people interested in software research?  
...
# **1.** Researchers = Software Developers?  {background-color="#67032F"}
Scientists create software as part of their research 
...
Anne wants to share R code to create some plot with a colleague
